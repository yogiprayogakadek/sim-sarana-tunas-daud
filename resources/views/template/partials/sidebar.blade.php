        ...
        @can('admin')
            <li>
                <a href="{{ route('siswa.index') }}" class="{{ Request::is('siswa') ? 'active' : '' }}">
                    <div class="pull-left"><i class="fa fa-users mr-20"></i><span class="right-nav-text">Siswa</span>
                    </div>
                    <div class="clearfix"></div>
                </a>
            </li>
            <li>
                <a href="{{ route('sarana.index') }}" class="{{ Request::is('sarana') ? 'active' : '' }}">
                    <div class="pull-left"><i class="fa fa-dropbox mr-20"></i><span class="right-nav-text">Sarana</span>
                    </div>
                    <div class="clearfix"></div>
                </a>
            </li>
        ...
        @can('admin')
            <li>
                <a href="{{ route('kerusakan.index') }}" class="{{ Request::is('kerusakan') ? 'active' : '' }}">
                    <div class="pull-left"><i class="fa fa-times mr-20"></i><span class="right-nav-text">Kerusakan</span>
                    </div>
                    <div class="clearfix"></div>
                </a>
            </li>
